...
> Blame is context, not decoration.
  blame-reveal renders *only what matters* — the visible viewport and recent commits — keeping Emacs fast even on large files.
...
(setq blame-reveal-display-layout 'normal)       ; 'line, 'normal, 'full
