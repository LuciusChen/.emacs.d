...
- 修改 Specific Quote 的样式，用 ~| (nerd-icons-mdicon "nf-md-format_quote_open"）~ 替代 ~(telega-symbol 'vertical-bar)~​。
...
#+CAPTION: telega-specific-reply
#+ATTR_ORG: :width 800
[[file:/Users/luciuschen/.emacs.d/assets/telega-specific-reply.png]]
