* .emacs.d
** 字体
字体这块折腾的真的比较多了，目前使用 [[https://www.jetbrains.com/lp/mono/][JetBrains Mono]] （2023-11-28）字体（因为 Telega 有了个 workaround gaps 可以让头像再也不裂了），[[https://orgmode.org/][Org mode]] 单独使用 iosevka。
