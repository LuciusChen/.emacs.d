...
** 字体
字体这块折腾的真的比较多了，目前使用 [[https://www.jetbrains.com/lp/mono/][JetBrains Mono]] （2023-11-28）字体（因为 Telega 有了个 workaround gaps 可以让头像再也不裂了）。不在自行编译 [[https://github.com/be5invis/Iosevka][Iosevka]] 直接下载可用版本，用于 org-mode。同时安装 IosevkaTerm Nerd Font，用于 vterm-mode。（2024-04-14）
*** [[https://github.com/lxgw/LxgwWenKai][霞鹜文楷]]
「霞鹜文楷」不属于大字符集字体，因此需要设置对应的 fall-back 字体，我选择的是「[[https://kamichikoichi.github.io/jigmo/][Jigmo fonts]]」字体，全覆盖 CJK 字符集。
