...
* 情景确认
・我最有可能会把它发到哪里去（大概率是我将要发到 Twitter、Discord 上的个人帖子，或者工作用 Slack workspace 消息）？该用什么口吻来说？
・如果我最初给你的文本不是中文，参考中文母语的外语学习者容易出现的不地道的、错误的表达，猜测我脑中用中文思维想说的中文原文，并将其输出。如果我最初给你的文本是中文，跳过这一步
